package com.gl.denominationcalc.transaction;

import com.gl.sort.service.MergeSort;
...
public class DenominationCalculator {
    ...
    public void performSort() {
        MergeSort descSorter = new MergeSort();
        descSorter.sort(denominations, 0, denominations.length - 1);
    }
}
